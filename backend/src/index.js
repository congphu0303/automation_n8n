...
const meetingRoomRouter = require("./models/meetingRoom");
...
// GET /api/rooms - Lấy danh sách phòng họp active
...
// GET /api/rooms/:id/slots - Lấy các slot đã đặt của phòng theo ngày
